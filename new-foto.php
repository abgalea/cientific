                        ...
                        <div class="panel-body">
                            <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="campoData" placeholder="Fecha Hecho" />
                                        </div>
                                        <div class="form-group">
                                            <label>Hora</label>
                                            <input class="form-control" id="campoData" placeholder="01:50" />
                                        </div>
                                        <div class="form-group">
                                            <label>Lugar</label>
                                            <input class="form-control" id="campoData" placeholder="Detalle Lugar" />
                                        </div>
                                        <div class="form-group">
                                            <label>Causa</label>
