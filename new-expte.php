...
font-size: 16px;"> Fecha Hoy <a href="salir.php" class="btn btn-danger square-btn-adjust">Salir</a> </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label>Nota Oficio Nro</label>
                                            <input class="form-control" placeholder="Nota Oficio Nro" />
                                        </div>
                                        <div class="form-group">
                                            <label>DO Nro</label>
                                            <input class="form-control" placeholder="DO Nro" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Sumario</label>
                                            <input class="form-control" placeholder="Sumario" />
                                        </div>
                                        <div class="form-group">
                                            <label>Pericia</label>
                                            <textarea class="form-control" rows="3"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="fegreso" placeholder="Fecha Egreso" />
                                        </div>
                                        <div class="form-group">
                                            <label>Responsable</label>
                                            <input class="form-control" placeholder="Ingrese responsable" />
                                        </div>
                                        <div class="form-group">
                                            <label>Plano</label>
                                            <input class="form-control" placeholder="Plano" />
                                        </div>
    ...
    <script>
		jQuery(function($){
           ...
           $("#campofactura").mask("9999-99999999");
